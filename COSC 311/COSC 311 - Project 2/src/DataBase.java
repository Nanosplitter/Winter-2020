...
public class DataBase {
    ...
    public DataBase() {
        ...
        this.firstIA = new IndexArray(false);
        this.lastIA = new IndexArray(false);
        this.IDIA = new IndexArray(true);
    ...
    public void deleteIt() {
    	...
    	if (this.IDIA.searchByKey(ID) == null) {
    ...
    public <K> void delete(K key) {
    	...
    	IDIA.deleteNode(IDIA.searchByKey(key));
    	firstIA.deleteNode(firstIA.searchByWhere(whereToDelete));
    	lastIA.deleteNode(lastIA.searchByWhere(whereToDelete));
